...
/*
    Purpose:
        - Opens tray for users to collected back their batteries upon rejection.
...
const CancelRecycling = () => {
    const { auth } = useAuth();
    const navigate = useNavigate();

    const done = () => {
        console.log("Done Retrieving Rejected Batteries");
...
export default CancelRecycling;