...
public class RateService {
    ...
    //need to create a RateRequest, do it later then modify.

//    public void createRate(BatteryRequest batteryRequest) throws CustomException {
...
////    }
//
//    public List<RareModel> deleteBattery(BatteryRequest batteryRequest){
